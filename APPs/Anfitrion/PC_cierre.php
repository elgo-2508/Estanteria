...
<body>
    <div class="position-relative overflow-hidden p-3 p-md-1 m-md-1 text-center bg-light">    
        <div class="p-12 p-md-1 mb-1 text-white rounded bg-secondary">
            <div class="row g-0">
                ...
                <h1 class="display-4 fw-normal">Resultado</h1>
                </div>
        ...
        <div class="p-12 p-md-2 mb-2 text-white rounded bg-dark">
            <div class="col-md-12 px-0">
                <?php require_once "back/PC_resultadoCierre.php"; ?>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        <?php
            ...
            $Consulta = "Exec [dbo].[PC_resultadoPartida] '".$Codigo."'";
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    {
                    label: "Descartadas",
                    data: [<?php foreach ($data as $d) echo $d[2] . ','; ?>],
                    backgroundColor: "rgba(255, 0, 0, 0.4)",
                    borderColor: "rgba(75,192,192,1)",
                    }  , 
                    {
                    label: "disponible",
                    data: [<?php foreach ($data as $d) echo $d[2]*0 . ','; ?>],
