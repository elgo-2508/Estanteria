...
<div class="container">  
    <div class='row align-items-center g-lg-5 py-3'>
        ...
        <div class='col-lg-5 col-md-10 mx-auto '>
            <form method="POST" action="PC_SalaEspera.php">
                ...
                <?php      
                    ...
                    $lever = 'M';
                    $frameSize = 3;
                    $contenido = 'http://'.$IPServ.'/GiraldGame/Participantes/Ingreso.php?Codigo='.$Codigo.'';
    ...
    <?php require_once "PC_IniciarPartida.PHP"; ?>
</body>
</html>
...
<script type="text/javascript">
    $(document).ready(function(){
            setInterval(
                function () {
                    $('#CargarParticipantes').load('Back/PC_CargarJugadores.php');
            }, 1000
            );
    });
</script>