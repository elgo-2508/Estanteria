...
<body>
    ...
    <div class="container">    
        <div class='row align-items-center g-lg-5 py-3'>
            <div class='col-lg-7 text-center text-lg-start'>
                ...
                <form method="POST" action="PC_salaJugador.php">
                    <h2>Participante</h2>
                    <h2><?php {echo $Participante;}?></h2>
                    <h2>El código de la partida es:</h2>
                    <h2><?php {echo $Codigo;}?></h2>
                    <button type='submit' class="btn btn-danger btn-block height25" name='RobarCarta'>
                    Iniciar
                    </button>
                </form>
            </div>
    ...
    <?php
    if(isset($_POST['RobarCarta']))
    {	
      include("../php/conexion_sql_server.php");
      $Consulta = "Exec [dbo].[PC_VerificarInicioPartida] '".$Codigo."'";
      ...
      while($row=sqlsrv_fetch_array($ejecutar)) 
      {
          if ($row['NumError']==0)
          {
            ...
            $_SESSION['CartasDisponibles']=$row['Descripcion'];
