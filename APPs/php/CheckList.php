...
?>
    ...
    ?>
        ...
        <td class="text-end"><input type="checkbox" <?php if ($row['JO'] ==1) {echo 'checked';} ?> name="TPList[]" value=<?php echo $row['tipo']; ?> id=<?php echo $row['tipo']; ?>></td>
        </tr>
    <?php
        $i=$i+1;
    }
