...
<body>
			...
			<section class="py-2 text-center container">
				<div class="row py-lg-2">
					<div class="col-lg-6 col-md-8 mx-auto">
						<h2 class="fw-light">Fase 1 - Observación</h2>
					</div>
					<div class="input-group input-group-sm mb-3">
						<span class="input-group-text" id="inputGroup-sizing-sm">Frase</span>
						<input class="form-control" name="Frase" type="text" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" />
					</div>
	...
	<script src="Librerias/alertifyjs/alertify.js"></script> <!-- alertas bonitas -->
	<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script><!-- alertas super bonitas -->
	<?php
		...
		if (isset($_POST["boton_seleccionado"])) 
		{
			...
			if ($Frase == "")
			{
				...
				Swal.fire({
					icon: 'error',
					title: 'Alerta',
					text: 'Debe diligenciar una frase!'
				  });
				</script>";	
				exit;			
			}
