		...
		<div class="content">
			...
			<form method="post">
                <section class="py-2 text-center container">
                    <div class="row py-lg-2">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            <h2 class="fw-light">Fase 3 - Puntuación</h2>
                        </div>
                    </div>
                </section>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group" >
                        <button type="submit" class="btn btn-sm btn-outline-secondary" name="boton_seleccionado" value="Validado">Validado</button>
                    </div>
                </div>
		    </form>
