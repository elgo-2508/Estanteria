        ...
        <div class='row align-items-center g-lg-5 py-3'>
            <div class='col-lg-12 text-center text-lg-start'>
                <div class="row g-0">
                    ...
                    <div class="col-auto">
                    <h1>Nuevo Juego Just One</h1>
                    </div>
                </div>            
                <form method="POST" action="JO_NuevoJuego.php">
                ...
                <br>
                <button type="submit" class="btn btn-primary" name="JO_NewGame">Iniciar</button>

                </form>
                <?php require_once "JO_CargarNuevoJuego.PHP"; ?>
                <br>
