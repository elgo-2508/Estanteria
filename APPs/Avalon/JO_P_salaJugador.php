...
<body>
    ...
    <div class="container">    
        <div class='row align-items-center g-lg-5 py-3'>
            <div class='col-lg-7 text-center text-lg-start'>
                ...
                <form method="POST" action="JO_P_salaJugador.php">
                    <h2>Participante</h2>
    ...
    {	
      ...
      $Consulta = "Exec [dbo].[JO_VerificarInicioPartida] '".$Codigo."'";
      $ejecutar = sqlsrv_query ($conn_sis, $Consulta);
      while($row=sqlsrv_fetch_array($ejecutar)) 
      {
          if ($row['NumError']==0)
          {
            //echo ' <script type="text/javascript"> alertify.success("El juego se '.$Participante.'ini9cion y se inicia la validacion");</script>';
