...
<html lang="en">
  ...
  <body>
	<main>
	<form method="POST" action="JO_P_Ingreso.php">
	  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
		<div class="row align-items-center g-lg-5 py-5">
		  <div class="col-lg-7 text-center text-lg-start">
			...
			<p class="col-lg-10 fs-4">Just ONE</p>
		  </div>
			  <div class="col-md-10 mx-auto col-lg-5">
				<form class="p-4 p-md-5 border rounded-3 bg-light">
				  <div class="form-floating mb-3">
					<input autocomplete="off" type="text" class="form-control" id="Codigo" name="Codigo" id="floatingInput" >
					<label for="floatingInput">Codigo</label>
				  </div>
				  <div class="form-floating mb-3">
					<input autocomplete="off" type="text" class="form-control" name="Participante" id="floatingInput" >
				  ...
				  <button class="w-100 btn btn-lg btn-primary" name="insert" type="submit">Ingresar</button>
				 	<br> </br> 
				  <button class="w-100 btn btn-lg btn btn-secondary" name="reinsert" type="submit">re-Ingresar</button>
				</form>
			  </div>
	...
	<?php require_once "JO_B_ValidarIngreso.php"; ?>
	</main>
  </body>
</html>
<script>
