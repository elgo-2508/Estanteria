...
<div class="container">  
    <div class='row align-items-center g-lg-5 py-3'>
        ...
        <div class='col-lg-5 col-md-10 mx-auto '>
            <form method="POST" action="JO_A_SalaEspera.php">
                ...
                <?php      
                    ...
                    $lever = 'M';
                    $frameSize = 3;
                    $contenido = 'http://'.$IPServ.'/GiraldGame/JustOne/JO_P_Ingreso.php?Codigo='.$Codigo.'';
...
<?php
	...
	{	
		...
		header('Location: JO_A_accion.php');
	}
?>
</body>
</html>
...
<script type="text/javascript">
    $(document).ready(function(){
            setInterval(
                function () {
                    $('#CargarParticipantes').load('JO_B_CargarJugadores.php');
            }, 1000
            );
    });
</script>