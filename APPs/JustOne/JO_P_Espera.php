...
<body>
  ...
  <div class="container">
    <div class="d-flex gap-5 justify-content-center">
        <h1> <span id="current-word">Esperar</span></h1>
    ...
    <div class="container px-4 py-5" id="hanging-icons"> 
    <div class="d-flex gap-5 justify-content-center">
      <p>En espera a que los demas participantes termine de registrar el datos</p>
    </div>
    </div>
    <div class="b-example-divider"></div>   
    <form method="post" action="JO_P_ValidarAccion.php">
      <div class="container px-4 py-5" id="hanging-icons"> 
        <div class="d-flex gap-5 justify-content-center">
