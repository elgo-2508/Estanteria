...
<body>
  ...
  <div class="container">
    <div class="d-flex gap-5 justify-content-center">
        <h1> <span id="current-word">Validar</span></h1>
    ...
    <div class="container px-4 py-5" id="hanging-icons"> 
        <div class="d-flex gap-5 justify-content-center">
            <h1> <span id="current-word">Palabra digitada</span></h1>
        </div>
        <div class="d-flex gap-5 justify-content-center">
            <input autocomplete="off" value=<?php {echo $Pal_Digita;}?> type="text" class="form-control" id="Codigo" name="Codigo" id="floatingInput" >
        </div>
        <br>
        <form method="post" action="JO_B_Guardar_Validar.php">
            <div class="d-flex gap-5 justify-content-center">
