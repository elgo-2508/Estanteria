  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="content">
          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="d-sm-flex justify-content-between">
                ...
                <div class="d-flex mb-3"><button class="btn btn-phoenix-primary me-2 px-6">Cancelar</button><button class="btn btn-primary">Crear</button></div>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-xl-12">
            <h4 class="mb-3">Parametrizacion de categorias </h4>
