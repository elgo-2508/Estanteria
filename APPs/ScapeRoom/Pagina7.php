...
<body style="background-color:#8D15D6;" >
  <div class="container mt-6">
    <h1 class="text-center">Codigos estanteria</h1>
      ...
      <div class="col-md-12">
        <form>
          <div class="form-row">
            ...
            <div class="form-group col-md-2">
              <input type="text" class="form-control" id="digito5" maxlength="1" required>
            </div>
          </div>
  ...
  <script>
    ...
    function validarCodigo() {
      ...
      var digito5 = document.getElementById('digito5').value;
      var codigo = digito1 + digito2 + digito3 + digito4+ digito5;
