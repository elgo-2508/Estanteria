        ...
        <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#home" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="home">
                      ...
                      <li class="nav-item"><a class="nav-link" href="../Dashboard/DashBoard.php" data-bs-toggle="" aria-expanded="false">
              ...
              <li class="nav-item"><!-- Administrador-->
                <!-- label-->
                  <div class="nav-item-wrapper">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="settings"></span></span><span class="nav-link-text">Administrador</span>
                    </div>
                    </a>
                    <div class="parent-wrapper label-1">
                      <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="icons">
                        <li class="collapsed-nav-item-title d-none">Administrador</li>
                        <li class="nav-item"><a class="nav-link" href="../Recursos/Clientes.php" data-bs-toggle="" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Clientes</span></div>
                        </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="../Recursos/Interventores.php" data-bs-toggle="" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Interventores</span></div>
                        </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="../apps/chat.php" data-bs-toggle="" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Plantillas</span></div>
                        </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="../apps/chat.php" data-bs-toggle="" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text">categorias</span></div>
                        </a><!-- more inner pages-->
                        </li>		  
                      </ul>
                    </div>
              ...
              <li class="nav-item"><!-- Gestion-->
                  <!-- label-->
                    <div class="nav-item-wrapper">
                      <a class="nav-link dropdown-indicator label-1" href="#Gestion" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="Gestion">
                      <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="trello"></span></span><span class="nav-link-text">Gestión</span>
                      </div>
                      </a>
                      <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="Gestion">
                          <li class="collapsed-nav-item-title d-none">Gestión</li>
                          <li class="nav-item"><a class="nav-link" href="../Gestion/Interventoria.php" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Interventoria</span></div>
                          </a><!-- more inner pages-->
                          </li>
                          <li class="nav-item"><a class="nav-link" href="../Gestion/Verificaciones.php" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Verificaciones</span></div>
                          </a><!-- more inner pages-->
                          </li>
                          <li class="nav-item"><a class="nav-link" href="../Gestion/DetalleHallazgo.php" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Hallazgos</span></div>
                          </a><!-- more inner pages-->
                          </li>  
                          <li class="nav-item"><a class="nav-link" href="../Gestion/PlanesdeMejora.php" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Planes de mejoramiento</span></div>
                          </a><!-- more inner pages-->
                          </li>  			  
                        </ul>
                      </div>
              ...
              <li class="nav-item"><!-- Presupuesto-->
                <!-- label-->
                <div class="nav-item-wrapper">
                  <a class="nav-link dropdown-indicator label-1" href="#Activiti" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="Activiti">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="file-text"></span></span><span class="nav-link-text">Actividades</span>
                  </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="Activiti">
                      <li class="collapsed-nav-item-title d-none">Actividades</li>
                      <li class="nav-item"><a class="nav-link" href="../Otros/Tareas.php" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Tareas</span></div>
                      </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="../Otros/Notificaciones.php" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Notificaciones</span></div>
                      </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="../apps/chat.php" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Calendarios</span></div>
                      </a><!-- more inner pages-->
                      </li>  
                    </ul>
                  </div>
...
<!-- label-->
  <div class="nav-item-wrapper">
		<a class="nav-link dropdown-indicator label-1" href="#Presup" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="Presup">
		<div class="d-flex align-items-center">
		  <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="dollar-sign"></span></span><span class="nav-link-text">Presupuesto</span>
		</div>
		</a>
		<div class="parent-wrapper label-1">
			<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="Presup">
			  <li class="collapsed-nav-item-title d-none">Presupuesto</li>
			  <li class="nav-item"><a class="nav-link" href="../Gestion/Interventoria.php" data-bs-toggle="" aria-expanded="false">
				  <div class="d-flex align-items-center"><span class="nav-link-text">Presupuesto x Interventoria</span></div>
				</a><!-- more inner pages-->
			  </li>
			</ul>
		</div>
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault" style="display:none;">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="../Dashboard/DashBoard.php">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="../../assets/img/icons/logo-1.png" alt="phoenix" width="27">
                  <p class="logo-text ms-2 d-none d-sm-block">Girald Games</p>
                </div>
              </div>
            </a>
          </div>
          ...
          <ul class="navbar-nav navbar-nav-icons flex-row">
            ...
            <!-- Visuliza menu de notificaciones-->
                ...
                <div class="card position-relative border-0">
                  <div class="card-header p-2">
                    <div class="d-flex justify-content-between">
                      <h5 class="text-black mb-0">Notificaciones</h5><button class="btn btn-link p-0 fs--1 fw-normal" type="button">Mark all as read</button>
                    </div>
                  </div>
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border border-300" aria-labelledby="navbarDropdownUser">
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top">
                    ...
                    <hr>
                    <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="../Login/Login.php"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
      ...
      <!-- Menu Horizontal colabado y demas-->
      <nav class="navbar navbar-top navbar-slim fixed-top navbar-expand" id="topNavSlim" style="display:none;">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            <button class="btn navbar-toggler navbar-toggler-humburger-icon hover-bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalCollapse" aria-controls="navbarVerticalCollapse" aria-expanded="false" aria-label="Toggle Navigation"><span class="navbar-toggle-icon"><span class="toggle-line"></span></span></button>
            <a class="navbar-brand navbar-brand" href="../Dashboard/DashBoard.php">InterCheck<span class="text-1000 d-none d-sm-inline">slim</span></a>
          </div>
          <ul class="navbar-nav navbar-nav-icons flex-row">
            <li class="nav-item">
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
        <div class="navbar-logo">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="../Dashboard/DashBoard.php">
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center"><img src="../../assets/img/icons/logo-1.png" alt="phoenix" width="27">
                <p class="logo-text ms-2 d-none d-sm-block">InterCheck</p>
              </div>
            </div>
          </a>
        </div>
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="authentication" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="Card" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="authentication/card/sign-in-1.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                          </a></li>
                        <li><a class="dropdown-item" href="authentication/card/sign-up-1.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                          </a></li>
                        <li><a class="dropdown-item" href="authentication/card/sign-out.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                          </a></li>
                        <li><a class="dropdown-item" href="authentication/card/forgot-password-1.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                          </a></li>
          ...
          <div class="d-flex flex-between-center dual-nav-first-layer">
            <div class="navbar-logo">
              ...
              <a class="navbar-brand me-1 me-sm-3" href="../Dashboard/DashBoard.php">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-center"><img src="../../assets/img/icons/logo-1.png" alt="phoenix" width="27">
                    <p class="logo-text ms-2 d-none d-sm-block">InterChek</p>
                  </div>
                </div>
              </a>
            </div>
      ...
      <!-- Scrip para manejo de menu vertical-->
      <script>
      ...
      <!--FIN Scrip para manejo de menu vertical-->      