        ...
        <section class="main-section">
					<form action="Pista3E1.php" method="post">
						<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-4 g-3 mb-9">
							...
							<div class="col">
								<h4 class="text-1100">Acces scenario 2</h4>
								<p class="mb-0 text-700">Authorization code granted by the captain, this will give you access to the next scenario.</p>
								...
								<br>
								<button class="btn btn-secondary" id="Validar"  name="ValidaE2P1">Verificar</button>
