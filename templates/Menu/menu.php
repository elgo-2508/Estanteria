      			...
      			<ul class="navbar-nav flex-column" id="navbarVerticalNav">
      					...
      					<div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#home"
      						...
      						<div class="parent-wrapper label-1">
      							<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="home">
      								...
      								<li class="nav-item"><a class="nav-link" href="../Dashboard/DashBoard.php"
      				...
      				<li class="nav-item">
      					...
      					<div class="nav-item-wrapper">
      						<a class="nav-link dropdown-indicator label-1" href="#icons" role="button"
      							data-bs-toggle="collapse" aria-expanded="false" aria-controls="icons">
      							<div class="d-flex align-items-center">
      								<div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span>
      								</div><span class="nav-link-icon"><span
      										data-feather="settings"></span></span><span
      									class="nav-link-text">Administrador</span>
      							</div>
      						</a>
      						<div class="parent-wrapper label-1">
      							<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="icons">
      								...
      								<li class="nav-item"><a class="nav-link" href="../../APPs/Admin/Categrias.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Categorias</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../../APPs/Admin/NuevoJuego.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span class="nav-link-text">Nuevo
      												Juego</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link"
      										href="../../APPs/Admin/PartidasActivas.php" data-bs-toggle=""
      										aria-expanded="false">
      										<div class="d-flex align-items-center"><span class="nav-link-text">Listado
      												de juegos</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../apps/chat.php" data-bs-toggle=""
      										aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Participantes x Juego</span></div>
      									</a><!-- more inner pages-->
      								</li>
      							</ul>
      						</div>
      				...
      				<li class="nav-item">
      					...
      					<!-- label-->
      					<div class="nav-item-wrapper">
      						<a class="nav-link dropdown-indicator label-1" href="#Gestion" role="button"
      							data-bs-toggle="collapse" aria-expanded="false" aria-controls="Gestion">
      							<div class="d-flex align-items-center">
      								<div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span>
      								</div><span class="nav-link-icon"><span data-feather="trello"></span></span><span
      									class="nav-link-text">Gestión</span>
      							</div>
      						</a>
      						<div class="parent-wrapper label-1">
      							<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="Gestion">
      								...
      								<li class="nav-item"><a class="nav-link" href="../Gestion/Interventoria.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Interventoria</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../Gestion/Verificaciones.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Verificaciones</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../Gestion/DetalleHallazgo.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Hallazgos</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../Gestion/PlanesdeMejora.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span class="nav-link-text">Planes
      												de mejoramiento</span></div>
      									</a><!-- more inner pages-->
      								</li>
      							</ul>
      						</div>
      				...
      				<li class="nav-item">
      					...
      					<!-- label-->
      					<div class="nav-item-wrapper">
      						<a class="nav-link dropdown-indicator label-1" href="#Activiti" role="button"
      							data-bs-toggle="collapse" aria-expanded="false" aria-controls="Activiti">
      							<div class="d-flex align-items-center">
      								<div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span>
      								</div><span class="nav-link-icon"><span
      										data-feather="file-text"></span></span><span
      									class="nav-link-text">Actividades</span>
      							</div>
      						</a>
      						<div class="parent-wrapper label-1">
      							<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
      								...
      								<li class="nav-item"><a class="nav-link" href="../Otros/Tareas.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Tareas</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../Otros/Notificaciones.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Notificaciones</span></div>
      									</a><!-- more inner pages-->
      								</li>
      								<li class="nav-item"><a class="nav-link" href="../apps/chat.php" data-bs-toggle=""
      										aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Calendarios</span></div>
      									</a><!-- more inner pages-->
      								</li>
      							</ul>
      						</div>
      				...
      				<li class="nav-item">
      					...
      					<!-- label-->
      					<div class="nav-item-wrapper">
      						<a class="nav-link dropdown-indicator label-1" href="#Presup" role="button"
      							data-bs-toggle="collapse" aria-expanded="false" aria-controls="Presup">
      							<div class="d-flex align-items-center">
      								<div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span>
      								</div><span class="nav-link-icon"><span
      										data-feather="dollar-sign"></span></span><span
      									class="nav-link-text">Presupuesto</span>
      							</div>
      						</a>
      						<div class="parent-wrapper label-1">
      							<ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="Presup">
      								...
      								<li class="nav-item"><a class="nav-link" href="../Gestion/Interventoria.php"
      										data-bs-toggle="" aria-expanded="false">
      										<div class="d-flex align-items-center"><span
      												class="nav-link-text">Presupuesto x Interventoria</span></div>
      									</a><!-- more inner pages-->
      								</li>
      							</ul>
      						</div>
      	...
      	<div class="collapse navbar-collapse justify-content-between">
      		<div class="navbar-logo">
      			...
      			<a class="navbar-brand me-1 me-sm-3" href="../Dashboard/DashBoard.php">
      				<div class="d-flex align-items-center">
      					<div class="d-flex align-items-center"><img src="../../assets/img/icons/logo-1.png"
      					...
      					<div class="list pb-3">
      						...
      						<div class="py-2"><a class="dropdown-item"
      							...
      							<a class="dropdown-item" href="../apps/e-commerce/landing/product-details.html">
      								<div class="d-flex align-items-center">
      									<div class="fw-normal text-1000 title"> <span
      											class="fa-solid fa-link text-900" data-fa-transform="shrink-2"></span>
      										Store MacBook″</div>
      								</div>
      							</a>
      						</div>
      		...
      		<ul class="navbar-nav navbar-nav-icons flex-row">
      			...
      			<li class="nav-item dropdown">
      				<div
      					style="background-image: url('../../assets/img/spot-illustrations/Creditos.png'); background-size: cover; background-position: left; background-repeat: no-repeat; width: 100%; ">
      					<a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
      						aria-expanded="false" data-bs-auto-close="outside">
      						<div style="width: 100px; text-align: center;">
      							<span data-feather="dollar-sign" style="height:15px;width:15px;">
      			...
      			<li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary"
      					href="../../../apps/e-commerce/landing/cart.html" role="button"><svg
      						xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"
      						fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      						stroke-linejoin="round" class="feather feather-shopping-cart text-700"
      						style="height:20px;width:20px;">
      						<circle cx="9" cy="21" r="1"></circle>
      						<circle cx="20" cy="21" r="1"></circle>
      						<path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
      					</svg><span class="icon-indicator-number">10</span></a>
							</li>
      			<!-- Visuliza menu de notificaciones-->
      			<li class="nav-item dropdown">
      				<a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
      					aria-expanded="false" data-bs-auto-close="outside">
      					<span data-feather="bell" style="height:20px;width:20px;"></span></a>
      					...
      					<div class="card position-relative border-0">
      						<div class="card-header p-2">
      							<div class="d-flex justify-content-between">
      								<h5 class="text-black mb-0">Notificaciones</h5><button
      					...
      					<div class="card position-relative border-0">
      						<div class="card-body p-0">
      							<div class="text-center pt-4 pb-3">
      								...
      								<h6 class="mt-2 text-black">Eduardo Giraldo G</h6>
      							</div>
      						...
      						<div class="card-footer p-0 border-top">
      							...
      							<div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100"
      									href="../Login/Login.php"> <span class="me-2" data-feather="log-out">
      									</span>Sign out</a></div>
      	...
      	<div class="collapse navbar-collapse justify-content-between">
      		<div class="navbar-logo">
      			<button class="btn navbar-toggler navbar-toggler-humburger-icon hover-bg-transparent" type="button"
      				...
      				aria-controls="navbarVerticalCollapse" aria-expanded="false" aria-label="Toggle Navigation"><span
      					class="navbar-toggle-icon"><span class="toggle-line"></span></span></button>
      			<a class="navbar-brand navbar-brand" href="../Dashboard/DashBoard.php">InterCheck<span
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
      	<div class="navbar-logo">
      		...
      		<a class="navbar-brand me-1 me-sm-3" href="../Dashboard/DashBoard.php">
      			<div class="d-flex align-items-center">
      				<div class="d-flex align-items-center"><img src="../../assets/img/icons/logo-1.png" alt="phoenix"
      						width="27">
      						...
      						<ul class="dropdown-menu">
      							...
      							<li class="dropdown"><a class="dropdown-item dropdown-toggle" id="Card" href="#"
      								...
      								<ul class="dropdown-menu">
      									...
      									<li><a class="dropdown-item"
      											href="authentication/card/forgot-password-1.html">
      											<div class="dropdown-item-wrapper"><span
      													class="me-2 uil"></span>Forgot password</div>
      										</a></li>
      							...
      							<div class="row gx-4 gy-5">
      								...
      								<div class="col-12 col-sm-6 col-md-4">
      									<div class="dropdown-item-group"><span class="me-2" data-feather="columns"
      										...
      										class="dropdown-link" href="../modules/tables/advance-tables.html">Advance
